...
<div class="dashboard" style="position: fixed;width: 18%;height: 100%;background:#222D32">
  ...
  <div style="background: #2d545e;font-size: 10pt;padding: 11px;color: #79978F;">MAIN NAVIGATION</div>
  <div>
...
<ol class="breadcrumb ">
    ...
    <?php echo $notice ?>
    <div style="width: 55%;margin: auto;padding: 22px;background: rgba(0, 0, 0, 0.3)" class="well well-sm center">
